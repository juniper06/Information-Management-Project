 ...
 */
public class DisplayMerchant extends javax.swing.JFrame {

    /**
     * Creates new form DisplayMerchant
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Merchant Information");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Merchant", "Description", "Address", "Email"
            }
        ));
    ...
    public void initData() {
        ...
        try {
            ResultSet rs = dbHelper.getMerchants();
            while (rs.next()) {
                int id = rs.getInt("id");
                String category = rs.getString("name");
                String item = rs.getString("description");
                String supplier = rs.getString("address");
                String customer = rs.getString("email");
                Object[] row = {id, category, item, supplier, customer};
                addRowToTable(row);
            }
        } catch (SQLException ex) {
            Logger.getLogger(DisplayMerchant.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayMerchant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayMerchant().setVisible(true);
            }
        });
    }
